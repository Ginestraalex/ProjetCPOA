...
#include "../Arche/interfacegraphique.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_InterfaceGraphique_t, stringdata) + ofs \
...
const QMetaObject InterfaceGraphique::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_InterfaceGraphique.data,
      qt_meta_data_InterfaceGraphique,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_InterfaceGraphique.stringdata))
